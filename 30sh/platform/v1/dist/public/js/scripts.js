...
(function ($) {
    ...
    if (postGallery) {
        var _postGallery$owlCarou;

        postGallery.owlCarousel((_postGallery$owlCarou = {
            items: 1,
            loop: true,
            nav: false,
            dots: true,
            autoplay: true
        }, _defineProperty(_postGallery$owlCarou, 'autoplay', 100), _defineProperty(_postGallery$owlCarou, 'autoplaySpeed', 100), _defineProperty(_postGallery$owlCarou, 'autoplayHoverPause', true), _defineProperty(_postGallery$owlCarou, 'animateOut', 'fadeOut'), _defineProperty(_postGallery$owlCarou, 'animateIn', 'fadeIn'), _defineProperty(_postGallery$owlCarou, 'smartSpeed', 1), _defineProperty(_postGallery$owlCarou, 'mouseDrag', true), _defineProperty(_postGallery$owlCarou, 'touchDrag', true), _defineProperty(_postGallery$owlCarou, 'autoHeight', true), _postGallery$owlCarou));
